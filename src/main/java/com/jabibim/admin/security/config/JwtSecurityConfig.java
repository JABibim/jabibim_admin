...
public class JwtSecurityConfig  {
 ...
 public JwtSecurityConfig(JwtTokenProvider jwtTokenProvider, AuthenticationConfiguration authenticationConfiguration, AcademyProperties academyProperties) {
   this.jwtTokenProvider = jwtTokenProvider;
   this.authenticationConfiguration = authenticationConfiguration;
   this.academyProperties = academyProperties;
 }
 ...
 public SecurityFilterChain jwtSecurityFilterChain(HttpSecurity http) throws Exception {
     ...
     LoginFilter loginFilter = new LoginFilter(authenticationManager(authenticationConfiguration), jwtTokenProvider, academyProperties);
     ...
     http
             ...
             .authorizeHttpRequests(auth -> auth.requestMatchers("/api/auth/login", "/api/public/**").permitAll()
